...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField USRENAME_FIELD_DESC = new org.apache.thrift.protocol.TField("usrename", org.apache.thrift.protocol.TType.STRING, (short)1);
  ...
  private _Fields optionals[] = {_Fields.USRENAME,_Fields.AGE,_Fields.MARRIED};
  public static final Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> metaDataMap;
  static {
    Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
    tmpMap.put(_Fields.USRENAME, new org.apache.thrift.meta_data.FieldMetaData("usrename", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public Person(Person other) {
    ...
    if (other.isSetUsrename()) {
      this.usrename = other.usrename;
    }
    this.age = other.age;
  ...
  public Person setUsrename(String usrename) {
    this.usrename = usrename;
    return this;
  }

  public void unsetUsrename() {
    this.usrename = null;
  }

  /** Returns true if field usrename is set (has been assigned a value) and false otherwise */
  public boolean isSetUsrename() {
    return this.usrename != null;
  }

  public void setUsrenameIsSet(boolean value) {
    if (!value) {
      this.usrename = null;
    }
  }
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_usrename = true && this.isSetUsrename();
    boolean that_present_usrename = true && that.isSetUsrename();
    if (this_present_usrename || that_present_usrename) {
      if (!(this_present_usrename && that_present_usrename))
        return false;
      if (!this.usrename.equals(that.usrename))
        return false;
    }
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = Boolean.valueOf(isSetUsrename()).compareTo(other.isSetUsrename());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUsrename()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.usrename, other.usrename);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetUsrename()) {
      sb.append("usrename:");
      if (this.usrename == null) {
        sb.append("null");
      } else {
        sb.append(this.usrename);
      }
      first = false;
    }
    if (isSetAge()) {
  ...
  private static class PersonStandardScheme extends StandardScheme<Person> {
        ...
        switch (schemeField.id) {
          case 1: // USRENAME
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.usrename = iprot.readString();
              struct.setUsrenameIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Person struct) throws org.apache.thrift.TException {
      ...
      if (struct.usrename != null) {
        if (struct.isSetUsrename()) {
          oprot.writeFieldBegin(USRENAME_FIELD_DESC);
          oprot.writeString(struct.usrename);
          oprot.writeFieldEnd();
        }
      }
      if (struct.isSetAge()) {
